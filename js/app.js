...
document.getElementById("city1").innerHTML = names_init[1];
document.getElementById("city2").innerHTML = names_init[2];
document.getElementById("city3").innerHTML = names_init[3];
document.getElementById("city4").innerHTML = names_init[4];
document.getElementById("city5").innerHTML = names_init[5];
document.getElementById("city6").innerHTML = names_init[6];
document.getElementById("city7").innerHTML = names_init[7];
document.getElementById("city8").innerHTML = names_init[8];
//document.getElementById("city9").innerHTML = names_init[9];
